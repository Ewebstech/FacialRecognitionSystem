...
class FaceDetector(object):
    ...
    def detect(self, image, biggest_only=True):
        ...
        face_cordinate = self.classifier.detectMultiScale(
            image_gray,
        ...
        face_coord = face_cordinate
        if not len(face_cordinate):
            xml_path2 = 'face_recognition_system/haarcascade_profileface.xml'
            cv2.CascadeClassifier(xml_path2)
